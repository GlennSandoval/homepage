...
Command: npx gltfjsx@6.2.15 old_computers.glb -t
...
export function OldComputers(props: JSX.IntrinsicElements["group"]) {
  const { nodes, materials } = useGLTF("/old_computers.glb") as GLTFResult;
  return (
